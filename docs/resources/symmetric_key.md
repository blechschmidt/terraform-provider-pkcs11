...
page_title: "pkcs11_symmetric_key Resource - pkcs11"
subcategory: ""
description: |-
  Generates a symmetric key on a PKCS#11 token using C_GenerateKey. All PKCS#11 attributes can be specified to control key properties.
---

# pkcs11_symmetric_key (Resource)
...
- `id` (String) Composite resource identifier (label/key_id_hex/CKO_SECRET_KEY).
